                                        ...
                                        <div className="relative overlayItemImage">
                                            ...
                                            <div>
                                                ...
                                                <div className="absolute left-1/2 -translate-x-1/2 z-50">
                                                    <button className="group opacity-0 bottom-[85px] px-[30px] border-[2px] xl:hover:border-transparent border-white py-[15px] relative z-50 min-w-[268px] xl:hover:bg-black text-white border-none bg-transparent hover:!bg-transparent items-center !block m-0 ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 justify-center gap-[20px] px-[15px] lg:gap-[160px] xl:px-[72px] my-[15px]  lg:my-[100px] ">
                    {
                        directors?.cardOverlay.map((overlayItem, index) => {
                            if (index !== 0) {
                                return (
                                    <div key={overlayItem.id} className="w-full lg:max-w-[300px] m-auto group relative">
                                    <div className="absolute top-0 left-0 w-full h-full bg-black opacity-40 z-20"></div>
                                        <div className="relative overlayItemImage">
                                            <Image
                                                src={overlayItem?.cardImage?.data?.attributes?.url}
