                                        ...
                                        return (
                                            <div key={socialItem.id} className="mr-[36px] last:mr-0">
                                                <Link href={socialItem.link} >
                                                    <Image src={`https://res.cloudinary.com/dyuydfuew/image/upload${socialItem.icon.data.attributes.url}`} width={24} height={24} alt="" ></Image>
                                                </Link>
                                            </div>
                                        )
                                    })
...

                    {
                        !isShown ?
                            ...
                            <ul className="hidden xl:block text-[#C2C5C9] text-center leading-[30px] text-[20px] border border-border transition-all duration-700 ease-in-out px-[5px] py-[5px] min-w-[504px] h-fit hamburgerRightSide relative min-h-[504px">
                                <Image src={`https://res.cloudinary.com/dyuydfuew/image/upload${hamburgerMenuRight.hoverImg.data.attributes.url}`} layout="responsive" width={504} height={563} objectFit="contain" alt="" ></Image>
                            </ul>
