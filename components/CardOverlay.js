                                    ...
                                    <div>
                                        ...
                                        <div className="absolute left-1/2 -translate-x-1/2 ">
                                        {
                                            ...
                                            <Link href={overlayItem?.buttonSlug}>
                                                <button className="group opacity-0 bottom-[85px] px-[15px] border-[2px] xl:hover:border-transparent border-white py-[15px]  items-center relative discoverButton min-w-[268px] xl:hover:bg-black text-white flex justify-center !duration-500">
